...
class Game:
	def __init__(self: Self, elements: list[str], name: str) -> None:
		...
		with open(os.path.join(BASE_DIR, 'data', 'nauka_questions.json')) as plik:
	...
	def load_user_data(self: Self, name: str, elements: list[str]):
		...
		file_path = os.path.join('data', 'nauka_user_data.json')
	...
	def save_user_data(self: Self) -> None:
		with open(os.path.join(BASE_DIR, 'data', 'nauka_user_data.json'), 'r') as plik:
		...
		with open(os.path.join(BASE_DIR, 'data', 'nauka_user_data.json'), 'w') as plik:
			json.dump(data, plik)
